    ...
    return (
        <button style={styles} className='text-white font-bold py-2 px-4 rounded'>
            <div className='flex flex-row justify-center items-center'>
                {tipo == 'Confirmar' ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                ...
                {tipo == 'Cancelar' ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                ...
                {tipo == 'Filtrar' ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">

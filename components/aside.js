...
export default function Aside() {
    var active = 'relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400';
    var inactive = 'px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group';
    ...
    return <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        <div>
            ...
            <div className="mt-8 text-center">
                ...
                <h5 className="hidden mt-4 text-xl font-semibold text-gray-600 lg:block">Karen Mendoza Rios</h5>
            </div>
        ...
        <div className="px-6 -mx-6 pt-4 flex justify-between items-center border-t hover:bg-gray-100">
